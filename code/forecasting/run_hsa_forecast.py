...
def run_single_forecast(k, forecast_date, method_name):
    ...
    # DATA LOAD
    # ---------------------------
    input_file = f"data/cluster_data_season/df_hsa_{method_name}_exclude_{target_season}_{k}.csv"
    ...
    output_path = root / "season" / f"TX_NSSP_hsa_{method_name}_{target_season}_{k}_pct"
...
def run_all_k_parallel(forecast_date, method_name, 
                       k_min=2, k_max=22, n_workers=None):
    """
